...
export default function AboutPage() {
  ...
  const partner = content.ourPartners[0];
  ...
  return (
    <>
      ...
      <SectionContainer id={partner.id} key={partner.id} sx={{ margin: 'auto', px: 3, maxWidth: '65rem' }} maxWidth={false}>
        <Typography variant="h2" sx={{ mt: '3rem' }}>{partner.title}</Typography>
        <Grid container>
          <iframe
            id={partner.id}
            title={partner.title}
