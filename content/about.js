...
header:'Our mission is to provide tools and guidance to help people clear their criminal records, granting them a second chance to enter society free from the stigma of their past.'
  ...
  ourStory: {
    header: 'Our Story',
    body: 'While the project started in Seatle, we now have volunteers all across the country and the world dedicating time outside of full-time jobs, graduate programs, and busy lives to help folks clear their criminal records-giving them a fighting change to escape a life full of poverty, homelessness, and recidivism.'
  },
  body: [
